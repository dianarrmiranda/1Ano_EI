...
public class Ex02 {
	...
	public static Alimento randAlimento() {
		...
		case 0:
			res = new Carne(VariedadeCarne.FRANGO, 22.3, 345.3, 300.0);
			break;
		case 1:
			res = new Peixe(TipoPeixe.CONGELADO, 31.3, 25.3, 200.0);
			break;
		case 2:
			res = new Legume("Couve Flor", 21.3, 22.4, 150.0);
			break;
		case 3:
			res = new Cereal("Milho", 19.3, 32.4, 110.0);
			break;
		}
		return res;
	}
